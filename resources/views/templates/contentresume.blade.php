				...
				<div class="section">
					...
					<div class="item">
						...
						<ul id="personal-details">
							<li><span>Name:</span>Ivan Vialenta</li>
							<li><span>Born on:</span>September 14, 1990</li>
							<li class="clearfix"><span>Address:</span>
								<ul id="address-lines">
									@include('templates/address')
								</ul>
							</li>
							<li><span>Phone:</span>+375(33)6878674</li>
							<li><span>Email:</span><a href="mailto:#">sweetmaerd@gmail.com</a></li>
						</ul>
